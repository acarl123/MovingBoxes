...
class NavigatorFrame ( wx.Frame ):
   ...
   def __init__( self, parent ):
      ...
      self.menuOpen = wx.MenuItem(self.fileMenu, wx.ID_ANY, u"Open EFS...", wx.EmptyString, wx.ITEM_NORMAL)
      self.fileMenu.AppendItem(self.menuOpen)

      self.menuLoad = wx.MenuItem(self.fileMenu, wx.ID_ANY, u"Load Canvas...", wx.EmptyString, wx.ITEM_NORMAL)
      self.fileMenu.AppendItem(self.menuLoad)
      ...
      self.latestRevisionMenuItem = wx.MenuItem(self.viewMenu, wx.ID_ANY, u"Latest Revision Mode", wx.EmptyString,
                                                wx.ITEM_NORMAL)
